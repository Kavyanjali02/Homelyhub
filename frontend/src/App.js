...
import ResetPassword from './Store/User/ResetPassword';
...
function App() {
  const stripePromise = loadStripe(
    "pk_test_51P01E6SGZ2vU9HVg1gxKWgUQ0HdloI81M8xm1oBV62d3lpskNntkY0MecH1tbNQMzNU6CYn3v2KWDQqQPVFrYvMs00iJIXzDwP"
  );
  ...
  const router = createBrowserRouter(
    ...
    //exact properties ensure that the route matches exactly as given in path
